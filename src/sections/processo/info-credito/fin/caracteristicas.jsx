...
export const principaisCaracteristicas = (dados) =>
  gerarTabela({
    ...
    rows: [
      ...
      { cells: 2, label: '5. Duração do contrato', value: dados?.prazo_amortizacao ?? '--' },
      ...
      { cells: 2, level: 2, label: '6.3. Montante das prestações', value: dados?.valor_prestacao ?? '--' },
      { cells: 2, level: 2, label: '6.3. Número de prestações', value: dados?.prazo_amortizacao ?? '--' },
      ...
      { cells: 2, level: 3, label: '9.1.2. Designação comercial do produto', value: dados?.seguro ?? '--' },
      ...
      { cells: 2, level: 3, label: '9.1.5. Duração exigida', value: dados?.duracao_seguro ?? '--' },
      {
        cells: 2,
        level: 3,
        label: '9.1.6. Outros requisitos mínimos exigidos',
        value: dados?.requisitos_minimos_seguro ?? '--',
      },
      {
        cells: 2,
        level: 3,
        label: '9.1.7. Periodicidade e valor de pagamento do prémio',
        value: dados.periodicidade_deguro ?? '--',
      },
