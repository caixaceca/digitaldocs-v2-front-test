...
// export const INTRANETFILE = 'http://172.17.8.78:5001';
// export const BASEURLDD = 'http://172.17.8.78:9900/forminga';
// export const INTRANETHUBAPI = 'http://172.17.8.78:5001/api';
...
export const INTRANETFILE = 'https://intraneteste.caixa.cv/corenet';
export const INTRANETHUBAPI = 'https://intraneteste.caixa.cv/corenet/api';

/// --------------------------- PRODUÇÃo --------------------------

// export const BASEURL = 'https://intranet.caixa.cv:5000';
// export const BASEURLSLIM = 'https://intranet.caixa.cv:8090';
// export const INTRANETFILE = 'https://intranet.caixa.cv/corenet';
// export const BASEURLDD = 'https://digitaldocs.caixa.cv/forminga';
// export const BASEURLGAJI9 = 'https://digitaldocs.caixa.cv/gaji9/api';
// export const INTRANETHUBAPI = 'https://intranet.caixa.cv/corenet/api';
