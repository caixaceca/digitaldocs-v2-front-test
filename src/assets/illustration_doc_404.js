...
const DocIllustration = memo((props) => {
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="90%" height="90%" viewBox="0 0 500 500">
        <g id="freepik--background-complete--inject-2">
          ...
          <path
            ...
            fill="#5aaa28"
          />
          <rect x="418.33" y="391.92" width="31.57" height="0.25" fill="#5aaa28" />
          <rect x="301.93" y="389.21" width="33.41" height="0.25" fill="#5aaa28" />
          <rect x="396.59" y="401.21" width="62.43" height="0.25" fill="#5aaa28" />
          <rect x="52.46" y="399.53" width="19.23" height="0.25" fill="#5aaa28" />
          <rect x="80.6" y="399.53" width="30.29" height="0.25" fill="#5aaa28" />
          <rect x="189.58" y="395.31" width="54.56" height="0.25" fill="#5aaa28" />
          <polygon
          ...
          <path
            ...
            fill="#e0e0e0"
          />
          <polygon points="215.28 175.12 275.07 182.83 272.26 118.13 215.28 175.12" fill="#e6e6e6" />
          <polygon points="215.28 175.12 272.26 175.12 272.26 118.13 215.28 175.12" fill={neutral} />
          <path
        ...
        <g id="freepik--Shadow--inject-2">
          <ellipse id="freepik--path--inject-2" cx="250" cy="430" rx="220" ry="25" fill={neutral} />
        </g>
      </svg>
    ),
    [paper, neutral]
  ...
  return <Box {...props}>{svgContent}</Box>;
});
